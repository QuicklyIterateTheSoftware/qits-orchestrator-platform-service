package eu.wohlben.qits.orchestrator.telemetry;
 ...
 * edit, would otherwise stop this service's logging with a green build and no error anywhere. What
 * would go missing is the only unattended account of a gc run: what the schedule and the deploy
 * trigger started, and how each run ended.
 *
