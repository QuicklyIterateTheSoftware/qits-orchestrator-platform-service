 ...
 * dependency between two modules that deliberately have none. {@code orchestrator} and {@code service} each carry one. The databases are named per module for the same reason a container would be — so two suites
